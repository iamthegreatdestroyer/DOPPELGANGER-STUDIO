            ...
            SceneDialogue(
                ...
                dialogue_lines=[
                    DialogueLine(
                        ...
                        emotion="excited",
                        timing_notes="Bursts in enthusiastically",
                    ),
                    DialogueLine(
                        character="Riko",
                        line="Ay, Luna! What now?",
                        emotion="exasperated",
                        timing_notes="Looks up from reading",
                    ),
                    DialogueLine(
                        character="Luna",
                        line="I'm going to audition for the station talent show!",
                        emotion="determined",
                        timing_notes="Strikes a dramatic pose",
                    ),
                ],
                voice_profile_used=sample_voice_profiles["Luna"],
            ...
            SceneDialogue(
                ...
                dialogue_lines=[
                    DialogueLine(
                        ...
                        emotion="defensive",
                        timing_notes="Caught in the act",
                    ),
                    DialogueLine(
                        character="Riko",
                        line="Ay, Luna! How did this happen?",
                        emotion="confused",
                        timing_notes="Surveys the chaos",
                    ),
                ],
                voice_profile_used=sample_voice_profiles["Riko"],
            ...
            SceneDialogue(
                ...
                dialogue_lines=[
                    DialogueLine(
                        ...
                        emotion="excited",
                        timing_notes="Another scheme",
                    ),
                    DialogueLine(
                        character="Riko",
                        line="Oh no...",
                        emotion="worried",
                        timing_notes="Braces for disaster",
                    ),
                ],
                voice_profile_used=sample_voice_profiles["Luna"],
                total_runtime_estimate=40.0,
