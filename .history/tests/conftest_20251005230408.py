...
# Phase 4: Script Generation Fixtures


@pytest.fixture
def mock_claude_client():
    """Provide a mock Claude AI client for Phase 4."""
...
@pytest.fixture
def mock_gpt_client():
    """Provide a mock GPT-4 client for Phase 4."""
    mock_client = AsyncMock()
    mock_client.generate = AsyncMock(
        return_value='{"test": "response"}'
    )
...
def joke_optimizer(mock_claude_client, mock_gpt_client):
    """Provide a JokeOptimizer instance with mocked AI clients."""
