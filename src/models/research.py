...
class TMDBData(BaseModel):
    ...
    cast: List[CastMember] = Field(default_factory=list, description="Main cast (top 15)")
    ...
    seasons: List[SeasonData] = Field(default_factory=list, description="Season information")
