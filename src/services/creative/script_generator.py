...
from src.services.creative.stage_directions import StageDirectionGenerator
...
class ScriptGenerator:
    ...
    def generate_full_script(
        ...
        """
        Generate complete production-ready script.
        
        Orchestrates the full pipeline:
        1. Generate dialogue for each scene
        ...
        logger.info(f"Generating {len(scenes_outline)} scenes...")
        scene_scripts = []
        
        for scene_outline in scenes_outline:
    ...
    def _generate_scene_script(
        ...
        """
        Generate complete script for a single scene.
