...
WikipediaResearchScraper class for scraping TV show information from
Wikipedia.

Key components:
- WikipediaShowData: Data structure for holding show data.
- WikipediaResearchScraper: Class for performing async scraping.
...
class WikipediaShowData:
    """
    Data structure for holding TV show data from Wikipedia.
